...
class net_regression(nn.Module):
    ...
    def __init__(self, database):
        ...
        self.nb_layer = np.random.randint(low=80,
                                          high=200)
    ...
    def __build_dataset__(self):
        self.dataset_train = Dataset_regression(database=self.database,
                                                mode="train")
        self.dataset_validation = Dataset_regression(database=self.database,
                                                     mode="validation")
